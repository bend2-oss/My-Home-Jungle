...
// Очистка каталога
function clean() {
    return del(['dist/*', '!dist/img'], ['dist/*', '!dist/fonts']) // !dist/img исключаем из удаления каталог img
}
...
function scripts() {
    return gulp.src(["src/scripts/sliders/swiper-bundle.min.js", "src/scripts/sliders/ItcSimpleSlider.js", "src/scripts/sliders/articlesSlider.js", "src/scripts/sliders/headerSlider.js", "src/scripts/sliders/aboutPlantsSlider.js"]) //paths.scripts.src
        .pipe(sourcemaps.init())
        .pipe(babel({
